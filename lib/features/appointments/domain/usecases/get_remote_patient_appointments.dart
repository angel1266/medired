...
class GetRemotePatientAppointmentsUseCase {
  final AppointmentsRepository _appointmentsRepository;

  GetRemotePatientAppointmentsUseCase(this._appointmentsRepository);

  Stream<DataState<List<Appointment>>> call({required String uid}) {
    return _appointmentsRepository.getUpcomingPatientAppointments(uid);
  }
}
