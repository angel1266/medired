...
class SolicitudpacienteModal extends StatefulWidget {
  const SolicitudpacienteModal({super.key});
  @override
  State<SolicitudpacienteModal> createState() => _SolicitudpacienteModalState();
}

class _SolicitudpacienteModalState extends State<SolicitudpacienteModal> {
  @override
  void initState() {
    super.initState();
  }
      ...
      SizedBox(
          ...
          child: Column(
            children: [
              ...
              Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: titulosTypeToString[TitulosType.title3]!
                    .asMap()
                    .map((index, titulo) {
                      return MapEntry(
                        index,
                        apartado(titulo, 'text', AppColors.greenBackground,
                            Colors.white, lettersize, textaling),
                      );
                    })
                    .values
                    .toList(),
        ...
        child: Column(
          ...
          children: [
            ...
            apartado("Motivo", solicitud.motivo, AppColors.greenBackground,
                lettercolor, lettersize, textaling),
            apartado("Síntomas", solicitud.sintomas ?? "N/A",
...
void showSolicitudPacienteModal(BuildContext context) {
  showModalBottomSheet(
    useSafeArea: true,
    context: context,
    isScrollControlled: true,
    builder: (context) {
      return const SolicitudpacienteModal();
    },
  );
}
